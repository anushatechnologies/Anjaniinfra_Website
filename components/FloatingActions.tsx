...
import { MessageSquare, Phone, Mail, X, Sparkles, ArrowRight } from 'lucide-react';
...
export function FloatingActions({ onOpenEstimate, onOpenConsultation }: FloatingActionsProps) {
  ...
  return (
    <>
      ...
      <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40 flex flex-col items-end gap-2 pointer-events-none">
        ...
        <a
          ...
          className="pointer-events-auto flex items-center gap-2 bg-[#2B5573] hover:bg-[#1A374D] text-white px-3 py-2 sm:py-2.5 rounded-l-xl shadow-lg transition-all hover:-translate-x-1 duration-200 group text-xs font-semibold"
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-5 sm:right-5 z-40 flex flex-col items-end gap-2">
        ...
        {!isChatOpen && !isPromptDismissed && (
          <div 
            onClick={() => setIsChatOpen(true)}
            className="bg-white border border-gray-200 rounded-xl px-3.5 py-2 shadow-xl cursor-pointer hover:shadow-2xl transition-all duration-200 flex items-center gap-2.5 animate-fade-in group relative"
          >
            ...
            <button
              ...
              className="ml-1 text-gray-400 hover:text-gray-700 p-0.5 rounded-full hover:bg-gray-100 transition-colors"
        ...
        <button
          ...
          className="w-13 h-13 sm:w-14 sm:h-14 rounded-full bg-[#132B3E] hover:bg-[#0F2231] border-2 border-[#C5A059]/40 text-white shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-105 cursor-pointer relative"
        ...
        {isChatOpen && (
          <div className="w-[340px] sm:w-[380px] bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col animate-scale-in mb-2">
            ...
            <div className="p-4 bg-gray-50 max-h-[360px] overflow-y-auto space-y-3">
              ...
              {/* Quick Actions (Zero Form) */}
              <div className="space-y-2 pt-1">
                <p className="text-[11px] text-gray-500 font-medium">Choose an option to connect immediately:</p>
                <div className="flex flex-col gap-2">
                  ...
                  <a
                    ...
                    rel="noopener noreferrer"
                    onClick={() => setIsChatOpen(false)}
                    className="p-2.5 bg-[#25D366]/10 hover:bg-[#25D366] text-gray-900 hover:text-white border border-[#25D366]/40 rounded-xl text-xs font-semibold transition-all flex items-center justify-between group cursor-pointer"
                  >
                    ...
                    <span className="text-[10px] text-gray-500 group-hover:text-white/90 font-normal">Fastest</span>
                  </a>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded-full bg-[#132B3E] text-[#C5A059] flex items-center justify-center shrink-0">
                  ...
                  <button
                    ...
                    className="text-left p-2.5 bg-white hover:bg-amber-50/60 border border-amber-200 text-[#132B3E] rounded-xl text-xs font-semibold transition-colors flex items-center justify-between group cursor-pointer"
                  >
                    <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="text-left p-2.5 bg-white hover:bg-amber-50/60 border border-gray-200 hover:border-amber-200 text-gray-800 hover:text-[#132B3E] rounded-xl text-xs font-semibold transition-colors flex items-center justify-between group cursor-pointer"
                  >
                    <span>Book Free Designer Session</span>
                    <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-0.5 transition-transform text-gray-400 group-hover:text-[#C5A059]" />
                  </button>
                </div>
              </div>
            </div>
