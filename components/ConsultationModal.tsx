...
import { X, Sparkles, Phone, ShieldCheck, Clock, MapPin, ArrowRight } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl max-w-md w-full overflow-hidden shadow-2xl border border-gray-100 flex flex-col relative animate-scale-in">
        ...
        <div className="p-6 space-y-4">
          <p className="text-xs text-gray-600 text-center leading-relaxed">
            Connect directly with our senior interior architects in Hyderabad. Get immediate design guidance, cost estimates, or share your floor plans.
          </p>
          ...
          >
            <div className="flex items-center gap-3.5">
              <div className="w-11 h-11 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow group-hover:scale-105 group-hover:bg-white group-hover:text-[#25D366] transition-all">
          ...
          >
            <div className="flex items-center gap-3.5">
              <div className="w-11 h-11 rounded-full bg-[#132B3E] text-[#C5A059] flex items-center justify-center shadow group-hover:scale-105 group-hover:bg-[#C5A059] group-hover:text-[#132B3E] transition-all">
          ...
          <div className="pt-3 border-t border-gray-100 grid grid-cols-2 gap-2 text-[11px] text-gray-600">
            ...
            <div className="flex items-center gap-1.5 col-span-2 text-gray-500">
              ...
              <span>Experience Centres Across Hyderabad</span>
            </div>
          </div>
        </div>
